...
void setup() {
  ...
  pinMode(vsOutPin_flip, OUTPUT); //1/10/20
...
void loop() {
  ...
  camExposureState = digitalRead(camExposureInPin); //1/10/20
    ...
    digitalWrite(vsOutPin, 1-camExposureState); //6/10/20
    digitalWrite(vsOutPin_flip, camExposureState); //6/10/20
