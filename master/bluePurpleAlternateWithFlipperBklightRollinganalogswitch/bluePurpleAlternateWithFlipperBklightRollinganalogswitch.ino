...
const int pdinpin = 1;
const int pdandcamExposureOutPin = 12;    // 
...
void setup() {
  ...
  pinMode(pdandcamExposureOutPin, OUTPUT); //23/10/20
...
void loop() {
  ...
  camExposureState = digitalRead(camExposureInPin); //1/10/20
    ...
    digitalWrite(pdandcamExposureOutPin, currentpdstate & camExposureState); //23/10/20
